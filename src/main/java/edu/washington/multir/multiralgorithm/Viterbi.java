...
public class Viterbi {
	...
	public Parse parse(MILDocument doc, int mention, Map<Integer,Map<Integer,Double>> featureScoreMap) {
		...
		for (int s = 0; s < numRelations; s++)
			scores[s] = parseScorer.scoreMentionRelation(doc, mention, s, featureScoreMap.get(s));
